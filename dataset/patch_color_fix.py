...
wsis = [77, 107, 57, 68, 89, 90, 92, 95, 98, 99, 103, 104,  109, 111, 120, 121, 122, 129, 131, 132, 135, 139, 141, 142, 145, 146, 149, 150, 153, 156, 159, 161, 162, 164, 165, 166, 168, 169, 60, 62, 63, 68, 69,  78, 79, 80, 87]
...
for wsi in wsis:
    ...
    #         img_bgr_wrong = cv2.imread(f"{input_dir}/{filename}")
    #         img_rgb = cv2.cvtColor(img_bgr_wrong, cv2.COLOR_BGR2RGB)
    #         cv2.imwrite(f"{input_dir}/{filename}", img_rgb)
    all_tif_paths = [
