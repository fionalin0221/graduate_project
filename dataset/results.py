...
output_file = "/home/ipmclab-2/project/Results/Mix_NDPI/100WTC_Result/LP_3200/100WTC_LP3200_trial_1_hcc_tati_results_new.csv"
cl = "H"
...
for num_trial in num_trials:
    for _wsi in wsi_list:
        if cl == "H":
            ...
            wsi = f"1{_wsi:04d}"
        file_path = f"{base_path}/trial_{num_trial}/{wsi}/Metric/{wsi}_100WTC_LP3200_3_class_trial_{num_trial}_test_result_new.csv"
