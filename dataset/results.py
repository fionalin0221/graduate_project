...
# large test set
# HCC_wsi_list = [105, 117, 133, 147, 148, 151, 153, 154, 159, 160, 168, 169, 170, 171, 178, 180, 181, 183, 186, 189, 190, 194, 195, 198, 200, 202, 211, 212, 213, 220, 222, 223, 226, 230, 232, 233, 236, 237, 240, 241]
CC_wsi_list =  [373, 376, 377, 378, 379, 380, 390, 391, 392, 400, 401, 402, 406, 407, 408, 409, 410, 422, 454, 455, 459, 460] #, 146, 158, 163, 164, 165, 363, 461, 468, 469, 470, 471, 472, 474, 475, 476, 483, 484]
...
def collect_results(wsi, cl, results):
    if len(wsi) == 5:
        ...
        file_path = f"{base_path}/trial_{num_trial}/{wsi}/Metric/{wsi}_1WTC_LP{data_num}_{num_class}_class_trial_{num_trial}_test_result.csv"
        # file_path = f"{base_path}/{wsi}/trial_{num_trial}/Metric/{wsi}_1WTC_LP{data_num}_{num_class}_class_trial_{num_trial}_test_result.csv"
